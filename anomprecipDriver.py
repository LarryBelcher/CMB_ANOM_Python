...
p1 = subprocess.Popen("python anomprecipMap.py "+fdate+" "+imgsize, shell=True)
p1.wait()


if(imgsize != 'GEO'):
	p2 = subprocess.Popen("python anomprecipColorbar.py "+fdate+" "+imgsize, shell=True)
	p2.wait()
...
if(imgsize == '620' or imgsize == '1000'):
	...
	imgw = str(im3.size[0])
	imgh = str(im3.size[1])
	img_name = 'precipanom-monthly-cmb--'+imgw+'x'+imgh+'--'+yyyy+'-'+mm+'-00.png'
...
if(imgsize == 'DIY'):
	...
	cbar_name = 'precipanom-monthly-cmb--'+yyyy+'-'+mm+'-00_colorbar.eps'
	cmd = 'mv '+im2+' '+cbar_name
	subprocess.call(cmd, shell=True)	
	cmd1 = 'zip precipanom-monthly-cmb--'+imgw+'x'+imgh+'--'+yyyy+'-'+mm+'-00.zip '+img_name+' '+cbar_name+' noaa_logo.eps '
	subprocess.call(cmd1, shell=True)
	cmd2 = 'mv precipanom-monthly-cmb--'+imgw+'x'+imgh+'--'+yyyy+'-'+mm+'-00.zip '+img_path
...
if(imgsize == 'GEO'):
	...
	tifimg_name = 'precipanom-monthly-cmb--'+tifimgw+'x'+tifimgh+'--'+yyyy+'-'+mm+'-00.tif'
...
if(imgsize == 'HD'):
	...
	if(mm != '00'): draw.text((xpos,815), labeldate, (0,0,0), font=fnt1)
	if(mm == '00'): draw.text((xpos,815), ms, (0,0,0), font=fnt1)
	...
	ttext = "Percent of average precipitation"
	draw.text((213,797), ttext, (0,0,0), font=fnt2)
	fnt3 = ImageFont.truetype(fntpath, 14)
	ttext = "Compared to 1981-2010 average"
	draw.text((213,815), ttext, (0,0,0), font=fnt3)
	...
	img_path = './Images/Precipitation/'+imgsize.lower()+'/'
	img_name = 'precipanom-monthly-cmb--'+imgw+'x'+imgh+'hd--'+yyyy+'-'+mm+'-00.png'
	pngfile = img_path+img_name
	print "Saving "+pngfile
	hdim.save(pngfile)
...
if(imgsize == 'HDSD'):
	...
	if(mm != '00'): draw.text((xpos,781), labeldate, (0,0,0), font=fnt1)
	if(mm == '00'): draw.text((xpos,781), ms, (0,0,0), font=fnt1)		
	fnt2 = ImageFont.truetype(fntpath, 14)
	ttext = "Percent of average precipitation"
	draw.text((400,768), ttext, (0,0,0), font=fnt2)
	fnt3 = ImageFont.truetype(fntpath, 14)
	ttext = "Compared to 1981-2010 average"
	draw.text((400,785), ttext, (0,0,0), font=fnt3)	
	...
	img_path = './Images/Precipitation/'+imgsize.lower()+'/'
	img_name = 'precipanom-monthly-cmb--'+imgw+'x'+imgh+'hdsd--'+yyyy+'-'+mm+'-00.png'
	pngfile = img_path+img_name
	print "Saving "+pngfile
	hdim.save(pngfile)